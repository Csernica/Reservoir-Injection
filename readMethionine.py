...
Author: Tim Csernica
This code will read in the methionine data from .txt files and output a .json with the results.
"""
...
fragmentDict = {'150':['13C-13C','18O','34S','D','13C','33S','15N','Unsub']}
